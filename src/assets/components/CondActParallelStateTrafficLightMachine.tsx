  ...
  return (
    <div className="grid grid-flow-row gap-5">
      ...
      >
        ...
        <div className={`bg-red-500 w-[100px] h-[100px] rounded-full absolute top-5 left-9 border-dotted border-2 border-red-500 bg-shadow-red bg-size-5 radial-gradient-brown ${current.matches("red.blinking") ? "blinking" : (current.matches("red.turnedOn") ? "opacity-100" : "opacity-10")}`}></div>
        <div className={`bg-yellow-400 w-[100px] h-[100px] rounded-full absolute top-[145px] left-9 border-dotted border-2 border-yellow-400 bg-shadow-yellow bg-size-5 radial-gradient-orange ${current.matches("yellow.blinking") ? "blinking" : (current.matches("yellow.turnedOn") ? "opacity-100" : "opacity-10")}`}></div>
        <div className={`bg-green-600 w-[100px] h-[100px] rounded-full absolute top-[270px] left-9 border-dotted border-2 border-green-600 bg-shadow-green bg-size-5 radial-gradient-lime ${current.matches("green.blinking") ? "blinking" : (current.matches("green.turnedOn") ? "opacity-100" : "opacity-10")}`}></div>
      </div>
      {current.matches("green.turnedOn") && 
