...
function CondActParallelStateTrafficLightMachine() {
  ...
  return (
    <div className="grid grid-flow-row gap-5">
      <h1 className="text-center">Context, Conditions and Actions</h1>
      ...
      <p className="text-center">Actions to toggle next green light: {`${current.actions.map((action) => action.type)}`}</p>
      <p className="text-center">If NextIsGreen = false, red light appears after yellow</p>
